...
All the environments are registered in the `G1_controller` extension. They start
...
import G1_controller.tasks  # noqa: F401


def main():
    """Print all environments registered in `G1_controller` extension."""
